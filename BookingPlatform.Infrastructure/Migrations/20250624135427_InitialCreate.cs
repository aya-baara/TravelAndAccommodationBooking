        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPriceBeforeDiscount = table.Column<decimal>(type: "decimal(8,6)", precision: 8, scale: 6, nullable: false),
                    TotalPriceAfterDiscount = table.Column<decimal>(type: "decimal(8,6)", precision: 8, scale: 6, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Percentage = table.Column<decimal>(type: "decimal(8,6)", precision: 8, scale: 6, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(8,6)", precision: 8, scale: 6, nullable: false),
